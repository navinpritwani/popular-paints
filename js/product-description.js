function productSearch(name){
            ...
            document.getElementById('title').style.marginTop = '100px';
	            if( name === 'cock-weather-plus'){
	                document.getElementById('productName').innerHTML ="Cock Weather Plus";
	                document.getElementById('product-img').src='product-images/full/cock-weather-plus.png';
	            	document.getElementById('productDescription').innerHTML = "Premium Quality Silicon base paint with high sheen water repellent technology.";
	            ...
	            else if(name === 'cock-plast'){
	                document.getElementById('productName').innerHTML ="Cock Plast";
	                ...
	                document.getElementById('productName').innerHTML ="Active Sheild";
	                ...
	                document.getElementById('productName').innerHTML ="Eco Plast";
	                ...
	                document.getElementById('productName').innerHTML ="Cock Feather Touch";
	                document.getElementById('product-img').src='product-images/full/cock-feather-touch.png';
	                ...
	                document.getElementById('productName').innerHTML ="Cock Orchid";
	                ...
	                document.getElementById('productName').innerHTML ="Active Touch";
	                ...
	                document.getElementById('productName').innerHTML ="Wall Passion";
	                ...
	                document.getElementById('productName').innerHTML ="Active Acrylic";
	                ...
	                document.getElementById('productName').innerHTML ="Pearl Finish";
